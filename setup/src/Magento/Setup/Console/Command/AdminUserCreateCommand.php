...
class AdminUserCreateCommand extends AbstractSetupCommand
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$input->getOption(AdminAccount::KEY_USER)) {
            $question = new Question('<question>Demo user:</question> ', '');
        ...
        if (!$input->getOption(AdminAccount::KEY_PASSWORD)) {
            $question = new Question('<question>Demo password:</question> ', '');
        ...
        if (!$input->getOption(AdminAccount::KEY_EMAIL)) {
            $question = new Question('<question>Demo email:</question> ', '');
            $this->addNotEmptyValidator($question);
        ...
        if (!$input->getOption(AdminAccount::KEY_FIRST_NAME)) {
            $question = new Question('<question>Demo first name:</question> ', '');
            $this->addNotEmptyValidator($question);
        ...
        if (!$input->getOption(AdminAccount::KEY_LAST_NAME)) {
            $question = new Question('<question>Demo last name:</question> ', '');
            $this->addNotEmptyValidator($question);
    ...
    public function getOptionsList($mode = InputOption::VALUE_REQUIRED)
    {
        ...
        return [
            new InputOption(
                ...
                null,
                $mode,
                $requiredStr . 'Demo user'
            ),
            new InputOption(
                AdminAccount::KEY_PASSWORD,
                null,
                $mode,
                $requiredStr . 'Demo password'
            ),
            new InputOption(
                AdminAccount::KEY_EMAIL,
                null,
                $mode,
                $requiredStr . 'Demo email'
            ),
            new InputOption(
                AdminAccount::KEY_FIRST_NAME,
                null,
                $mode,
                $requiredStr . 'Demo first name'
            ),
            new InputOption(
                AdminAccount::KEY_LAST_NAME,
                null,
                $mode,
                $requiredStr . 'Demo last name'
            ),
        ];
    }
