<?php
namespace Exam\Discount\Model\DiscountProduct\ResourceModel\DiscountProduct\Collection;

/**
 * Interceptor class for @see \Exam\Discount\Model\DiscountProduct\ResourceModel\DiscountProduct\Collection
 */
class Interceptor extends \Exam\Discount\Model\DiscountProduct\ResourceModel\DiscountProduct\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListIdProductOfDiscount');
        return $pluginInfo ? $this->___callPlugins('getListIdProductOfDiscount', func_get_args(), $pluginInfo) : parent::getListIdProductOfDiscount($idDiscount);
    }

    /**
     * {@inheritdoc}
     */
    public function getDiscountOfProduct($CustomerGroup, $idProduct)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDiscountOfProduct');
        return $pluginInfo ? $this->___callPlugins('getDiscountOfProduct', func_get_args(), $pluginInfo) : parent::getDiscountOfProduct($CustomerGroup, $idProduct);
    }
