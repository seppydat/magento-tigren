<?php
namespace Exam\Discount\Model\Discount\ResourceModel\Discount\Collection;

/**
 * Interceptor class for @see \Exam\Discount\Model\Discount\ResourceModel\Discount\Collection
 */
class Interceptor extends \Exam\Discount\Model\Discount\ResourceModel\Discount\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListDiscount');
        return $pluginInfo ? $this->___callPlugins('getListDiscount', func_get_args(), $pluginInfo) : parent::getListDiscount($CustomerGroup);
    }
