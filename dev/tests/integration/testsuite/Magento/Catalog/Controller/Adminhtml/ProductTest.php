...
class ProductTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testEditAction()
    {
        ...
        $this->assertEquals(
            ...
            '"Save" button isn\'t present on Edit.php Product page'
        );
        ...
        $this->assertEquals(
            ...
            '"Save & New" button isn\'t present on Edit.php Product page'
        );
        ...
        $this->assertEquals(
            ...
            '"Save & Duplicate" button isn\'t present on Edit.php Product page'
        );
    }
