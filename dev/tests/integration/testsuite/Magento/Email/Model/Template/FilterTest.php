...
class FilterTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function transDirectiveDataProvider()
    {
        return [
            ...
            'no padding' => [
                '{{trans"Testimonial cruel coder..."}}',
                [],
                'Testimonial cruel coder...',
            ],
            'multi-line padding' => [
                "{{trans \t\n\r'Testimonial cruel coder...' \t\n\r}}",
                [],
                'Testimonial cruel coder...',
            ],
            'capture escaped double-quotes inside text' => [
                '{{trans "Testimonial \"tested\" world!"}}',
                [],
                'Testimonial &quot;tested&quot; world!',
            ],
            'capture escaped single-quotes inside text' => [
                "{{trans 'Testimonial \\'tested\\' world!'|escape}}",
                [],
                "Testimonial &#039;tested&#039; world!",
            ],
            'filter with params' => [
                "{{trans 'Testimonial \\'tested\\' world!'|escape:html}}",
                [],
                "Testimonial &#039;tested&#039; world!",
            ],
            'basic var' => [
                '{{trans "Testimonial %adjective world!" adjective="tested"}}',
                [],
                'Testimonial tested world!',
            ],
            'auto-escaped output' => [
                '{{trans "Testimonial %adjective <strong>world</strong>!" adjective="<em>bad</em>"}}',
                [],
                'Testimonial &lt;em&gt;bad&lt;/em&gt; &lt;strong&gt;world&lt;/strong&gt;!',
            ],
            'unescaped modifier' => [
                '{{trans "Testimonial %adjective <strong>world</strong>!" adjective="<em>bad</em>"|raw}}',
                [],
                'Testimonial <em>bad</em> <strong>world</strong>!',
            ],
            'variable replacement' => [
                '{{trans "Testimonial %adjective world!" adjective="$mood"}}',
                [],
                'Testimonial happy world!',
                [
                    'mood' => 'happy'
                ],
            ],
