...
class EditTest extends AbstractBackendController
{
    ...
    /**
     * Tests Edit.php action without reviews_all resource when manipulating Pending review.
     *
     * @return void
    ...
    /**
     * Tests Edit.php action without pending and reviews_all resources.
     *
     * @return void
     */
