...
class FilterApplierTest extends TestCase
{
    ...
    {
        $standardInput = 'Testimonial ' . "\n" . ' &world!';
        return [
            'raw' => [['raw'], $standardInput, $standardInput],
            'standard usage' => [['escape', 'nl2br'], $standardInput, 'Testimonial <br />' . "\n" . ' &amp;world!'],
            'single usage' => [['escape'], $standardInput, 'Testimonial ' . "\n" . ' &amp;world!'],
            'params' => [
            ...
            'mixed filters' => [['', false, 'escape', 0, null], $standardInput, 'Testimonial ' . "\n" . ' &amp;world!'],
        ];
    }
    ...
    public function rawUseCaseProvider()
    {
        ...
        return [
            ...
            'standard usage' => ['|escape|nl2br', $standardInput, 'Testimonial <br />' . "\n" . ' &amp;world!'],
            'single usage' => ['|escape', $standardInput, 'Testimonial ' . "\n" . ' &amp;world!'],
            'default filters' => ['', $standardInput, 'Testimonial ' . "\n" . ' &amp;world!'],
